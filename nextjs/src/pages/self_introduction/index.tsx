  ...
  return (
    <Center w="100vw" h="100vh">
      ...
      >
        ...
        <HStack flexWrap="wrap" justifyContent="space-evenly" alignContent="center" spacing={[null, null, null, "72px"]}>
          <VStack
            flex={1}
            w="100%"
            alignItems="flex-start"
          ...
          >
            <HStack w="100%" flex="1 1 50%" alignItems="flex-end" spacing={[null, "24px", null, "32px"]}>
              ...
              <VStack alignItems="flex-start" spacing="48px">
                ...
                >
                  ...
                  <Text whiteSpace="nowrap">総合情報基盤センター（兼務）</Text>
                </VStack>
              </VStack>
            </HStack>
            ...
            >
              {careerList.map(
                ({ startedAt, endedAt, careerDetail: careerName }, index) => (
                  <Fragment key={`${startedAt}${endedAt}${careerName}${index}`}>
                    <ListItem>
                      <CareerSummaryCard
                        startedAt={startedAt}
                        endedAt={endedAt}
